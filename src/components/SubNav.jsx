...
export const SubNav = () => {
  ...
  return (
    <div className='relative '>
        ...
        <div className='grid grid-cols-4 gap-4 px-5 py-[50px] '>
            {DummyProduct.map((product) => (
                <div key={product.id} className='border p-10 group transition duration-300 relative overflow-hidden'>
                    <img src={product.image} alt={product.name} className=' h-[20vh] object-cover group-hover:scale-110 transition duration-300' />
